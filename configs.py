...
def add_args(parser):
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="topk for sample",
    )
    parser.add_argument(
        "--generate_focus", action="store_true", help="Whether to generate focus info when model is inferencing."
    )
    parser.add_argument(
        "--has_focus", action="store_true", help="Whether has focus info in the input data."
    )
    parser.add_argument(
        "--focus_len",
        type=int,
        default=10,
        help="The focus sequence length.",
    )
    parser.add_argument(
        "--has_explain", action="store_true", help="Whether has explain info in the input data."
    )
    parser.add_argument(
        "--causal_seq_model_path",
        default=None,
        type=str,
        help="The causal seq model path.",
    )
    parser.add_argument(
        "--causal_tok_model_path",
        default=None,
        type=str,
        help="The causal tok model path.",
    )
